...
var Pretender = (function (self$1, RouteRecognizer, FakeXMLHttpRequest) {
  'use strict';

  self$1 = self$1 && self$1.hasOwnProperty('default') ? self$1['default'] : self$1;
...
}(self, RouteRecognizer, FakeXMLHttpRequest));
